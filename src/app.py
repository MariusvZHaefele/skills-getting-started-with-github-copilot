...
# Mount the static files directory to serve the frontend HTML, CSS, and JavaScript files
...
activities = {
    ...
    "Drama Club": {
        "description": "Theater performance, acting workshops, and stage production",
